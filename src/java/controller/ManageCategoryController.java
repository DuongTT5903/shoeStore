 ...
 * @author truonglam
 */
@WebServlet(name = "ManageCategoryController", urlPatterns = {"/ManageCategoryController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            if (button.equals("Update")) {
                ...
                Category category = categoryDBContext.getCategoryByID(cateID);
                category.setCategoryName(cateName);
                categoryDBContext.updateCategory(cateName, category);
                ...
                Category category = categoryDBContext.getCategoryByID(cateID);
                category.setCategoryName(cateName);
                categoryDBContext.removeCategory(cateID);
            }
        } finally {
