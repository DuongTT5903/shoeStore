    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(button.equals("Update")){
                ...
                Account acc = new Account(username, password, fullname, Boolean.FALSE, Boolean.parseBoolean(status));
                AccountDBContext accountDBContext = new AccountDBContext();
                accountDBContext.updateAccount(acc);
            } else if(button.equals("Delete")){
                String username = request.getParameter("tentk");
                AccountDBContext accountDBContext = new AccountDBContext();
                accountDBContext.removeAccount(username);
            }
        } finally{
